...
const RULES = [
    { id: 'nsuserdefaults', name: 'NSUserDefaults Insecure Storage', severity: 'warning', confidence: 70,
      ...
      cwe: 'CWE-312', owasp: 'M2', masvs: 'STORAGE-2', mitre: 'T1409', category: 'storage' },
    { id: 'coredata', name: 'CoreData Unencrypted Storage', severity: 'warning', confidence: 60,
      ...
      cwe: 'CWE-312', owasp: 'M2', masvs: 'STORAGE-14', mitre: 'T1409', category: 'storage' },
    ...
    { id: 'keychain', name: 'Keychain Secure Storage', severity: 'secure', confidence: 90,
      ...
      masvs: 'STORAGE-1', mitre: 'T1409 (mitigates)', category: 'storage' },
    ...
    { id: 'weak_md5', name: 'Weak Hash Algorithm (MD5)', severity: 'high', confidence: 85,
      ...
      cwe: 'CWE-327', owasp: 'M5', masvs: 'CRYPTO-4', mitre: 'T1521', category: 'crypto' },
    ...
    { id: 'weak_des', name: 'Weak Encryption (DES / 3DES)', severity: 'high', confidence: 90,
      ...
      cwe: 'CWE-327', owasp: 'M5', masvs: 'CRYPTO-3', mitre: 'T1521', category: 'crypto' },
    ...
    { id: 'insecure_random', name: 'Insecure RNG', severity: 'warning', confidence: 70,
      ...
      cwe: 'CWE-330', owasp: 'M5', masvs: 'CRYPTO-6', mitre: 'T1521', category: 'crypto' },
    ...
    { id: 'http_url', name: 'Insecure HTTP URL', severity: 'high', confidence: 80,
      ...
      cwe: 'CWE-319', owasp: 'M3', masvs: 'NETWORK-1', mitre: 'T1638', category: 'network' },
    { id: 'ssl_disabled', name: 'SSL/TLS Validation Disabled', severity: 'high', confidence: 90,
      ...
      cwe: 'CWE-295', owasp: 'M3', masvs: 'NETWORK-4', mitre: 'T1638', category: 'network' },
    { id: 'ssl_pinning', name: 'SSL/Certificate Pinning Found', severity: 'secure', confidence: 75,
      ...
      masvs: 'NETWORK-4', mitre: 'T1521.003 (mitigates)', category: 'network' },
    ...
    { id: 'logging', name: 'Debug Logging', severity: 'warning', confidence: 50,
      ...
      cwe: 'CWE-532', owasp: 'M9', masvs: 'STORAGE-3', mitre: 'T1533', category: 'leakage' },
    { id: 'clipboard', name: 'Pasteboard / Clipboard Access', severity: 'warning', confidence: 60,
      ...
      cwe: 'CWE-200', owasp: 'M2', masvs: 'STORAGE-10', mitre: 'T1414', category: 'leakage' },
    { id: 'screenshot', name: 'Background-Screenshot Risk', severity: 'info', confidence: 55,
      ...
      cwe: 'CWE-200', owasp: 'M2', masvs: 'STORAGE-9', mitre: 'T1513', category: 'leakage' },
    { id: 'cache', name: 'URL/HTTP Cache Usage', severity: 'info', confidence: 50,
      ...
      cwe: 'CWE-524', owasp: 'M2', masvs: 'STORAGE-5', mitre: 'T1409', category: 'leakage' },
    ...
    { id: 'jailbreak', name: 'Jailbreak Detection', severity: 'secure', confidence: 75,
      ...
      masvs: 'RESILIENCE-1', mitre: 'T1630.003 (mitigates)', category: 'resilience' },
    { id: 'antidebug', name: 'Anti-Debug Protection', severity: 'secure', confidence: 75,
      ...
      masvs: 'RESILIENCE-2', mitre: 'T1629 (mitigates)', category: 'resilience' },
    ...
    { id: 'webview_js', name: 'JavaScript Execution in WebView', severity: 'warning', confidence: 65,
      ...
      cwe: 'CWE-79', owasp: 'M7', masvs: 'PLATFORM-6', mitre: 'T1407', category: 'platform' },
    ...
    { id: 'biometric', name: 'Biometric Authentication', severity: 'info', confidence: 80,
      ...
      masvs: 'AUTH-8', mitre: 'T1461 (mitigates)', category: 'auth' },
    { id: 'file_no_protection', name: 'File Without Data Protection', severity: 'high', confidence: 90,
      ...
      cwe: 'CWE-311', masvs: 'STORAGE-1', mitre: 'T1409', category: 'storage' },
    ...
    { id: 'objc_swizzle', name: 'Objective-C Method Swizzling', severity: 'info', confidence: 70,
      ...
      masvs: 'RESILIENCE-9', mitre: 'T1617', category: 'resilience' },
    { id: 'dynamic_library', name: 'Dynamic Library Loading', severity: 'warning', confidence: 70,
      ...
      cwe: 'CWE-427', masvs: 'RESILIENCE-9', mitre: 'T1407', category: 'resilience' },
    ...
    { id: 'location_tracking', name: 'Location Access', severity: 'info', confidence: 90,
      ...
      masvs: 'PRIVACY-1', mitre: 'T1430', category: 'privacy' },
    { id: 'contacts_access', name: 'Contacts Access', severity: 'info', confidence: 90,
      ...
      masvs: 'PRIVACY-1', mitre: 'T1636.003', category: 'privacy' },
    { id: 'camera_microphone', name: 'Camera / Microphone Access', severity: 'info', confidence: 85,
      ...
      masvs: 'PRIVACY-1', mitre: 'T1512, T1429', category: 'privacy' },

    { id: 'swiftui_detected', name: 'SwiftUI Framework Detected', severity: 'info', confidence: 80,
      patterns: [/\bimport\s+SwiftUI\b/g, /\bSwiftUICore\b/g, /\b_SwiftUI\b/g, /\bSwiftUI\.framework\b/g, /@State\b/g, /@ObservedObject\b/g, /@EnvironmentObject\b/g, /:\s*View\b\s*\{/g],
      description: 'App uses SwiftUI (declarative UI framework). Informational — helps scope UI-layer review to SwiftUI-specific patterns (state leaks via @State/@Binding, unencrypted @AppStorage).',
      masvs: 'PLATFORM-1', category: 'platform' },
    { id: 'appstorage_detected', name: '@AppStorage Usage (UserDefaults-backed)', severity: 'warning', confidence: 70,
      patterns: [/@AppStorage\b/g],
      description: 'SwiftUI @AppStorage persists to UserDefaults — same plaintext-on-disk exposure as NSUserDefaults. Avoid for tokens, PII, or secrets.',
      cwe: 'CWE-312', owasp: 'M2', masvs: 'STORAGE-2', mitre: 'T1409', category: 'storage' },
];
        ...
        for (const pattern of rule.patterns) {
            ...
            while ((m = pattern.exec(scanned)) !== null) {
                ...
                findings.push({
                    ...
                    cwe: rule.cwe || '', owasp: rule.owasp || '', masvs: rule.masvs || '', mitre: rule.mitre || '',
...
function applyDedupeAndConfidence(findings, opts) {
    const Entropy = (typeof self !== 'undefined' ? self.IPAS : root.IPAS)?.Entropy;
    const o = opts || {};
    const map = new Map();
